...
from rooms.models import AbstractCreate
...
from prop_home.utilities.file_handlers import handle_post_file_upload
...
class Blog(AbstractCreate):
    ...
    def get_absolute_url(self):
        return reverse("prop_home:blog-details", kwargs={"blog_slug": self.slug})
